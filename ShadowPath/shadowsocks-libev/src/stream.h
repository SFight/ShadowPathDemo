...
int stream_encrypt_all(buffer_t *, cipher_t *, kx_ctx_t *, size_t);
int stream_decrypt_all(buffer_t *, cipher_t *, kx_ctx_t *, size_t);
int stream_encrypt(buffer_t *, cipher_ctx_t *, size_t);
int stream_decrypt(buffer_t *, cipher_ctx_t *, size_t);

void stream_ctx_init(cipher_t *, kx_ctx_t *, cipher_ctx_t *, int);
