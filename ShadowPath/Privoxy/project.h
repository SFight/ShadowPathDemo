...
/**
 * Flag for csp->flags: Set if the SSProxy-Connection header
...
/** configuration_spec::feature_flags: SSProxy authentication headers are forwarded instead of removed. */
